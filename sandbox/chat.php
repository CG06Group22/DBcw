    ...
    <div class="container">
        ...
        <ul class="list-group">
            ...
            while($row=mysqli_fetch_array($result)) {
                ...
                echo "<li class='list-group-item'><a href='groupChat.php?$gid'>$groupName</a>";

                ?>

                <button class='btn btn-primary' data-toggle='modal' data-target='#myModal2'>Detail
                </button>
                ...
                <div class="modal-header">
                    ...
                    Add members to <?php echo $groupName; ?>
                </div>
                ...
                <ul class="list-group">
                    ...
                    $friend = "friend";
                    $sql5 = "SELECT guestUserID FROM relationship WHERE relationship = '$friend' AND hostUserID = '$target'";
                    ...
                    if (!$count > 0) {
                        ...
                        while($row=mysqli_fetch_array($result5)) {
                            ...
                            $sql6 = "SELECT firstName, lastName FROM users WHERE email = '$guestUserID'";
                            ...
                            ?>
                            <li class='list-group-item'><a href='others-profile.php?<?php echo $guestUserID ?>'></a>
                              <?php
                              echo $fullName;
                            ...
                            if (!$rowadd = mysqli_fetch_assoc($resultIfIn)){
                                ?>
                                <a href='../includes/addToGroup.php?u=$guestUserID&g=$gid'>Add</a></li>
                                <?php
                            }
                        }
                    }
